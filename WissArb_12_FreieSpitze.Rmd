...
date: "2025/02/03 (updated: `r Sys.Date()`)"
output:
...
### Einheit 12: Freie Spitze und Fragen
##### 04.02.2025 | Prof. Dr. Caroline Zygar-Hoffmann
...
* **Kausale Sprache** im gesamten Bericht nur dann nutzen, wenn ein experimentelles Design vorliegt (vgl. Einheit 10, Folie 22)
...
* Abgabetermin ist der **10.03.2025** (23:55)

* Jeder aus der Gruppe muss abgeben! 

* Abgabe von:
  - Bericht als Word-Dokument, welches den Link zum OSF-Projekt enthält (wo anonymisierte Daten, formr-Codebook, Präregistrierung und R-Skripte liegen) 
