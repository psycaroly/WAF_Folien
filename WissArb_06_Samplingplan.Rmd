...
date: "2023/11/18 (updated: `r Sys.Date()`)"
output:
...
##### 19.11.2024 | Dr. Caroline Zygar-Hoffmann
...
* Verbindliche Angaben zum nötigen Stichprobenumfang für eine bestimmte Analyse nur möglich, wenn eine hypothesenprüfende Untersuchung mit vorgegebener Effektgröße geplant wird $\rightarrow$ **a priori Poweranalyse** 
  ...
  - Üblichste Poweranalyse, haben Sie in den Vorlesungen zu "Quantitative Methoden" kennengelernt

* Falls die Stichprobengröße aus anderen Gründen festgelegt ist (wie bei den Gruppen mit eigenem Thema): v
  - Ziel: Abzuschätzen wie hoch die statistische Power für die Aufdeckung eines Effekts mit dieser Stichprobengröße ist 
  - Wichtig: eine post hoc Analyse auf dem *gefundenen* Effekt aus der eigenen Studie macht keinen Sinn, nur eine auf dem *erwarteten* Effekt
...
* Für Ihre Projekt auch ok (aus rein pragmatischen Gründen): eine Primärhypothese rausgreifen, und dafür die Powerhypothese machen (aber besser wäre es für den kleinsten erwarteten Effekt)

Relevante Parameter, hier am Beispiel für die a priori Poweranalyse:
...
A priori Poweranalyse für einen unabhängigen t-Test (auch für andere Hypothesentests möglich):
...
* und N = 60 Personen (30 Personen pro Gruppe) (*Hinweis: An der Vorlesung nehmen insgesamt 64 Studierende teil. Wenn die eigene Gruppe = 3-5 Personen nicht an der Studie teilnehmen, aber sonst alle, kommen Sie auf 61-59 Versuchspersonen.*)

erreicht man eine Power von 61% für einen einseitigen, unabhängigen t-Test; d.h. die Wahrscheinlichkeit einen Effekt zu finden, wenn er da ist, beträgt 61%. 
]
...
* **pwr.t.test()** für Einstichproben-t-test, sowie unabhängige und abhängige Zweistichproben-t-tests mit gleicher Gruppengröße; Angabe von Effektstärke d (siehe vorherige Folie)

* **pwr.t2n.test()** für t-tests bei ungleicher Gruppengröße
...
* **pwr.f2.test()** für Regression und mehrfaktorielle ANOVA; Angabe von Effektstärke f²
  ...
  * Angabe von u = Anzahl der Prädiktoren/Faktoren ohne Intercept (wenn es um das Gesamtmodell geht) oder = 1 (wenn es um einen einzelnen Prädiktor geht)
...
* Für Moderationshypothesen nach entsprechenden Angaben in der Literatur suchen, und in pwr.f2.test eingeben (u = 1 Prädiktor der uns interessiert = die Interaktion) $\rightarrow$ im Zweifelsfall (wenn man nichts findet) von einem kleinen Effekt ausgehen ( $f^2$ = 0.01-0.02)!
...
Beispiel 1 aus vorletztem Semester:
...
Beispiel 2 aus vorletztem Semester:
...
**Schritt 1:** [Präregistrierungstemplate auf studynet](https://studynet.hs-fresenius.de/goto_STUDYNETHSF_file_33416_download.html) um Sampling-Plan erweitern
...
**Schritt 2:** Poweranalyse
  ...
  * Eigenes Thema: **Sensitivitäts-Poweranalyse** machen, d.h. Wie sieht Ihre Power bei dem vorgegebenen Samplingplan aus (d.h. bei gesamt maximal 59-61 Versuchspersonen)?
  * Interventionsthema: **A priori-Poweranalyse** machen, d.h. wie viele Personen brauchen Sie für Ihre Hypothesen für eine Power von 80%?
  * Erweitern Sie das [Präregistrierungstemplate auf studynet](https://studynet.hs-fresenius.de/goto_STUDYNETHSF_file_33416_download.html) $\rightarrow$ Durchgeführte Poweranalyse in M3 berichten
...
**Schritt 3: Präregistrierung bis 25.11. einfrieren**
...
**Schritt 4: Implementierung des Fragebogens in formr finalisieren und mir bis 25.11. zuschicken**
...
* **Präregistrierung** sollte idealerweise bis **nächsten Montag 25.11.** eingefroren sein ( $\rightarrow$ falls Sie noch Fragen an Ihre Ansprechpartner haben klären Sie diese bald!)

* Damit Probleme in formr rechtzeitig gelöst werden können melden Sie sich **bis Freitag 22.11. bei mir, wenn Sie konkrete Probleme oder Fragen zu formr haben**

* **Zum Start der Datenerhebung:**
 - **Gruppen mit eigenem Thema**: Können mit der Datenerhebung starten, sobald a) die Präregistrierung eingefroren ist und b) Sie mir Ihren formr Run geschickt haben (wie das geht, siehe Einheit 4, Folie 36!)und ich ihn überprüft habe. Ich schicke Ihnen dann den Erhebungslink.
 ...
 - Alle Datenerhebungen sollten spätestens (!) am 28.11. starten (nachdem die Präregistrierung eingefroren wurde)!

$\rightarrow$ **Damit das klappt, schicken Sie mir Ihre formr Dateien ebenfalls bitte bis Montag, 25.11. zu.** Besonders bei den Gruppen mit Interventionsthema ist ein frühzeitiges Zuschicken hilfreich, da wir alle gemeinsam mit der Datenerhebung starten müssen und ich daher Ihre Änderungen noch zusammenfügen muss.
