...
date: "2025/07/14 (updated: `r Sys.Date()`)"
output:
...
##### 15.07.2025 | Prof. Dr. Caroline Zygar-Hoffmann
...
#### Basierend auf häufigen Fehlern, hier nochmal dedizierte Erinnerungen:
...
* **Kausale Sprache** im gesamten Bericht nur dann nutzen, wenn ein experimentelles Design vorliegt (vgl. Einheit 10, Folie 24)
...
1) Die in der Präregistrierung berichtete Poweranalyse (i.d.R. bei eigenem Thema: Sensitvititäspoweranalyse mit theoretisch erreichbarer Stichprobengröße, Ergebnis: Power; bei Interventionsthema: Poweranalyse zur Stichprobenplanung mit vorgegebener Power, benötigte Ergebnis: Stichprobengröße)
...
* **OSF-Projekt** checken:
  ...
  - Formr Excel-Datei(en) enthalten?
  - Analyse-Skripte enthalten (ggf. pro Person ein Ordner mit eigenen Skripten, falls nicht gemeinsames Skript für alle)? Wenn Sie die komplette Datenvorverarbeitung und Analyse im RMarkdown-Dokument eingefügt haben, reicht das RMarkdown - wenn Sie zusätzlich R-Skripte benutzt haben, sollten diese auch hochgeladen werden
  - optional für Gruppen mit eigenem Thema: Projekt auf public stellen (Button oben rechts)

* **Inhaltliche und technische Nachvollziehbarkeit der R-Skripte sicherstellen**: Versteht jemand anderes was er von vorne bis hinten machen muss, um die Ergebnisse zu reproduzieren und wirft R auf dem Weg dorthin keine Fehler?
...
* **Für Ihre Zukunft empfehlenswert:**
  - Auch wenn Sie eine sehr gute Note kommen: Ruhen Sie sich darauf nicht aus, es wird schwerer im weiteren Verlauf des Studiums (i.S.v. anspruchsvoller)
  - Klären Sie für zukünftige wissenschaftliche Arbeiten im Rahmen Ihres Studiums immer die Anforderungen! 
...
* Abgabetermin ist der **25.08.2025** (23:55)

* Jeder aus der Gruppe muss abgeben! 

* Abgabe von:
  - Bericht als Word-Dokument, welches den Link zum OSF-Projekt enthält (wo anonymisierte Daten, formr-Codebook, Präregistrierung und R-Skripte/RMarkdown-Datei liegen) 
  - Rohdaten (nicht-anonymisiert), d.h. die Dateien, die Sie von mir zugeschickt bekommen haben.
...
* Auf der letzten Seite Ihrer Arbeit:
  ...
  - Falls Ergebnis- und Diskussionsteil zusammen verfasst wurden (d.h. genauso wie der Gruppenarbeitsarteil identisch mit einem oder mehreren Gruppenmitgliedern ist), dann: Hinweis darauf welche anderen Gruppenmitglieder den gleichen Ergebnis-/Diskussionsteil haben 
...
<!-- library(renderthis) -->
<!-- to_pdf("WissArb_13_FreieSpitze.Rmd", complex_slides = TRUE) -->
