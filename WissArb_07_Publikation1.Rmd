...
date: "2024/11/25 (updated: `r Sys.Date()`)"
output:
...
##### 26.11.2024 | Dr. Caroline Zygar-Hoffmann
...
* **Wie viele Personen von der Interventionsgruppen rekrutiert werden sollen**: Da ich noch nicht alle Präregistrierungen dazu gesehen habe, verschiebe ich das Thema nochmal (und melde mich dazu per Email). Aber seien Sie versichert: Ich werde von Ihnen nicht verlangen Stichprobengrößen im Rahmen von hunderten pro Gruppe zu rekrutieren, selbst wenn das in der Poweranalyse rauskam!
...
* Gut wäre, wenn jeder an mindestens(!) 5 Studien teilnimmt (jede Studie sollte in wenigen Minuten erledigt sein)
...
* Danach schicke ich den finalen Link für die Erhebung rum inkl. finale Excel-Dateien zum Nachvollziehen
