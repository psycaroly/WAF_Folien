...
##### 05.06.2024 | Dr. Caroline Zygar-Hoffmann
...
**2 kleine Änderungen an der Einverständniserklärung (um die ich mich kümmere)**:
* public use file statt scientific use file
* Lehrzwecke ergänzt

**Wie viele Personen von der Interventionsgruppen rekrutiert werden sollen**: Da ich noch nicht alle Präregistrierungen dazu gesehen habe, verschiebe ich das Thema nochmal.
...
* Gut wäre, wenn jeder an mindestens(!) 10 Studien teilnimmt (jede Studie sollte in wenigen Minuten erledigt sein)
...
---
class: top, left
<div class="footer"><span>Zygar-Hoffmann, C., Pusch, S., Hagemeyer, B., & Schönbrodt, F. D. (2020). Motivated behavior in intimate relationships: Comparing the predictive value of motivational variables. Social Psychological Bulletin, 15(2), 1-37.</span></div>
...
* Bei 5 Leuten empfehle ich die folgende Aufteilung:
  ...
  - 2 Person Methodenteil (inkl. OSF-Projekt zur Bereitstellung von Material/Code/Daten)
