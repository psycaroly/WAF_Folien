---
title: "Zusatzmaterial: Literaturrecherche und Bewertung von Forschungsfragen"
...
### Zusatzmaterial: Bewertung von Forschungsfragen und Literaturrecherche
...
$\rightarrow$ Ihr Projekt muss so gestaltet sein, dass kein Ethikantrag notwendig ist **siehe Zusatzmaterial ["Ethik Checkliste" auf studynet](https://studynet.hs-fresenius.de/ilias.php?baseClass=ilrepositorygui&cmd=sendfile&ref_id=40715).**
...
* **Angaben zu Aufzeichnung, Aufbereitung, Speicherung und Löschung der Daten**
...
* Der Zugriff auf lizenzierte eRessourcen anderer Datenbanken als die der Bibliothek erfolgt über die Bibliothekssuche des Opera Browsers auf dem Terminalserver bzw. RDS/Remote Desktop. Andere Browser sind nicht für den Zugriff auf diese eRessourcen freigeschaltet. 

* Die Anleitung zur Einrichtung des Terminalservers befindet sich in der Wissensdatenbank unter folgenden Links (bitte wenden Sie sich bei Problemen mit der Einrichtung der Terminalservers an die IT itservices@crf-education.com): https://service.crf-education.com/external/knowledge-base/article/98 und https://service.crf-education.com/external/knowledge-base/article/49 
...
* Vergleiche: 
  ...
  - .small[https://mediatum.ub.tum.de/doc/1316333/1316333.pdf]
]
...
<!-- library(renderthis) -->
<!-- to_pdf("WissArb_Z2_Bewertung_Litrecherche.Rmd", complex_slides = TRUE) -->
