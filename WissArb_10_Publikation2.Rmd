...
##### 14.01.2025 | Prof. Dr. Caroline Zygar-Hoffmann
...
* Angabe der statistischen Kennwerte mit Freiheitsgraden in Klammern (z.B. t-Werte: t(df)=...; $\chi^2$(df)=...; etc. 
...
* Formalia zur Angabe von Ergebnissen (Zahlen) und Variablen:
  * lateinische Variablenbezeichnungen werden kursiv gesetzt, griechische jedoch nicht
  * Zahlen nicht kursiv
...
* Korrelation: $r = .13$, $95\%$ CI $[-0.13, 0.38]$, $p = .312$, $R^2 = .02$

* t-Test

  * entweder $\Delta_{M} = -51.46$, $95\%$ CI $[-104.87, 1.95]$, $t(49.09) = -1.94$, $p = .059$; Cohen's $d = -0.55$, $95\%$ CI $[-1.12, 0.02]$
  * oder group X ( $M = 1.2$, $SD = 0.2$) compared to group Y ( $M = 0.2$, $SD = 0.2$), $t(48) = 2.3$, $p = .026$; Cohen's $d = -0.55$, $95\%$ CI $[-1.12, 0.02]$
...
Folgende Studien brauchen noch dringend TeilnehmerInnen:
