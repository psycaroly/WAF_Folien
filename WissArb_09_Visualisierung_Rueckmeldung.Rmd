...
date: "2023/12/11 (updated: `r Sys.Date()`)"
output:
...
### Einheit 9: Datenvisualisierung und Rückmeldung
...
Bessere Alternative: Violin-Plots (auch "Pirate-Plots", linke Abbildung) oder Raincloud-Plots (rechte Abbildung)
...
* Rmarkdown Vorlage zur Rückmeldung  "[template_rueckmeldung.Rmd](#https://studynet.hs-fresenius.de/goto_STUDYNETHSF_file_24551_download.html)" von studynet herunterladen
...
* Oder das R-Skript auf studynet "[template_rueckmeldung_automate.R](#https://studynet.hs-fresenius.de/goto_STUDYNETHSF_file_24552_download.html)" ausprobieren (da bei großen Stichproben das manuelle Vorgehen ewig dauern würde)
...
<!-- library(renderthis) -->
<!-- to_pdf("WissArb_09_Visualisierung_Rueckmeldung.Rmd", complex_slides = TRUE) -->
