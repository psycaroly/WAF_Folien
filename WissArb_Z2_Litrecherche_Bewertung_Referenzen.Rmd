...
date: "2024/10/17 (updated: `r Sys.Date()`)"
output:
...
$\rightarrow$ Damit Sie außerhalb des HS-Netzes Zugriff auf die Volltexte lizenzierter Produkte haben, müssen Sie in Ihrem Browser einen Proxy aktivieren, Anleitung: https://service.crf-education.com/external/knowledge-base/article/49.
