...
date: "2025/06/30 (updated: `r Sys.Date()`)"
output:
...
### Einheit 11: Feedback & Publikation wissenschaftlicher Daten und Skripte
##### 01.07.2025 | Prof. Dr. Caroline Zygar-Hoffmann


---
class: top, left

### Hinweis: Folgende Studien sind noch offen
...
#### [Praxis Teil 1: Feedback](#praxis1)
...
#### [Praxis Teil 2: Open Data & Open Code](#praxis2)
...
Wer sich für **den Weg einer Studie bis zu einem publizierten Artikel** sowie einen Überblick über **Karrierepfade in der Wissenschaft** interessiert, der kann sich das [Zusatzmaterial Z6 auf studynet](https://studynet.hs-fresenius.de/ilias.php?baseClass=ilrepositorygui&cmd=sendfile&ref_id=46854) anschauen.

---
class: top, left
<div class="footer"><span>https://x.com/ithinkwellHugh/status/1927341662558167125</span></div>

### Gute wissenschaftliche Praxis

**Ein wichtiges Element im wissenschaftlichen Arbeiten ist also Feedback** (sowohl durch Externe i.S.v. peer-review, als auch durch Interne i.S.v. Mitautor:innen)


.center[
```{r eval = TRUE, echo = F, out.width = "45%"}
knitr::include_graphics("bilder/feedback.png")
```
]
...
Sie sollen sich innerhalb Ihrer Kleingruppe gegenseitig Feedback zu Ihren Texten geben (zumindest zu der Gruppenarbeit).
...
**Ein anderes wichtiges Element im wissenschaftlichen Arbeiten sind offene Daten**
...
.center[
```{r eval = TRUE, echo = F}
knitr::include_graphics("bilder/bewertung_opencode.png")
```
]
...
- formr Exceldateien als Codebuch im OSF-Projekt hochladen (wo auch die Präregistrierung liegt)

**Schritt 4: Code veröffentlichen**
- Entweder als Gruppe, oder individuell (in nach Name benannten Unterordnern)
- Entweder nur RMarkdown oder zusätzlich extra R-Skripte, je nachdem wo Sie Ihre Vorverarbeitung und Analysen gemacht haben

<!-- library(renderthis) -->
<!-- to_pdf("WissArb_11_Feedback_OpenData_OpenCode.Rmd", complex_slides = TRUE) -->
