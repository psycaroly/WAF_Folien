...
##### 29.04.2025 | Prof. Dr. Caroline Zygar-Hoffmann
...
zwei Beispielberichte inkl. RMarkdown aus einem vorherigen Semester sind nun [auf studynet zu finden](https://studynet.hs-fresenius.de/ilias.php?baseClass=ilrepositorygui&ref_id=42313)
...
1. Theoriearbeit und Forschungsfrage $\rightarrow$ Einheit 1 und letzte Sitzung, I1 & I2 in Präregistrierung

2. Hypothesen $\rightarrow$ letzte Sitzung, I3 & I4

3. Studiendesign $\rightarrow$ letzte Sitzung, M6, M10, M11, M14 & M15 

4. Operationalisierung (Auswahl Messinstrumente)  $\rightarrow$ heutige Sitzung, M12, M13, AP3 & AP4
...
#### Messinstrumente: Quellen und Beurteilung

* **Gruppen mit eigenem Thema:** Im Rahmen der Vorlesung primär auf [zis.gesis.org](zis.gesis.org) zurückgreifen 

* **Gruppen mit Interventionsthema:** Operationalisierung zentraler AVs ist vorgegeben (siehe Info-PDF), aber für Variablen im Rahmen der eigenen Forschungsfrage sind ggf. Operationalisierungen offen $\rightarrow$ hier können Sie gerne auf mich zukommen, ob ich zu einer Variable ggf. ein Messinstrument empfehlen kann

* **Grundsätzliches Vorgehen:** Literaturrecherche (z.B. in Google Scholar) mit den Schlagwörtern "questionnaire", "scale", "inventory", "test" $\rightarrow$ Veröffentlichung finden, welche die Entwicklung des Messinstruments beschreibt $\rightarrow$ Wortlaut von Items oft im Anhang, sonst Google-Suche nach Namen
...
#### Studienmaterial (= Study materials)

* **Genaue Gestaltung von Darbietungen/Aufgaben/Interventionen**: Je nach Studiendesign müssen Sie sich ggf. auch die genaue Umsetzung von Bedingungen (z.B. Instruktionen) oder Gestaltung von Stimulusmaterial (z.B. Videos) überlegen

* **Zum Beispiel beim Interventionsthema**: Instruktionen für Reflexions- und Kommunikationsaufgabe (für alles was im Info-PDF vom Interventionsthema steht sind die Instruktionen bereits von mir festgelegt; für die zusätzliche Bedingung die nachträglich auf Wunch einer Gruppe hinzugefügt wurde aber noch nicht)
...
Nachdem Items beantworten wurden, müssen i.d.R. folgende Schritte passieren, bevor die Daten in die Analyse eingehen:
...
* Items geben uns eine spezifische Information, aber wir wollen aber Aussagen über das dahinterliegende **Konstrukt** machen
...
**Erklärung zur Studie:** .small[Es freut uns sehr, dass Sie sich dafür interessieren, an dem Forschungsprojekt „Experimentelle Prüfung der Mikrodynamik von Motivations- und Regulationsprozessen in Partnerschaften“ unter der Leitung von Prof. Dr. Caroline Zygar-Hoffmann von der Charlotte Fresenius Hochschule, sowie Nensy Le und Prof. Dr. Felix Schönbrodt von der Ludwig-Maximilians-Universität München teilzunehmen. Diese Studie ist Teil eines Forschungsprogramms mit dem Ziel Effekte von Persönlichkeitsmerkmalen wie Bedürfnissen, verschiedenen motivationalen und emotionalen Zuständen und alltäglichem Verhalten in intimen Partnerschaften zu verstehen. Eine Fragestellung ist beispielweise: Welche Effekte haben bestimmet Verhaltensweisen auf Empfindungen in Bezug auf die Partnerschaft? 
...
* **Vorlagen auf studynet**: https://studynet.hs-fresenius.de/goto_STUDYNETHSF_file_41556_download.html für eigenes Thema und https://studynet.hs-fresenius.de/goto_STUDYNETHSF_file_42775_download.html für Interventionsthema
...
* **Markdown syntax** (zur Formatierung von Text): https://www.markdownguide.org/basic-syntax/
...
* Suchen Sie nach Fragebögen und Tests für Ihre zentralen Variablen (auf [zis.gesis.org](zis.gesis.org) oder Variable + "questionnaire", "scale", "inventory" oder "test").

* Entscheiden Sie sich für ein psychometrisch überprüftes Messinstrument pro zentraler Variable. Adaptieren/Verändern Sie Messinstrumente nur nach Rücksprache mit Ihrem Ansprechpartner. Eigene Entwicklungen von Fragen nur im Ausnahmefall und nach Rücksprache mit Ihrem Ansprechpartner möglich.

* Überlegen Sie sich ggf. genaue Formulierungen/Instruktionen oder konkretes Studienmaterial, falls Ihr Studiendesign sowas vorsieht.

* Ergänzen Sie ggf. weitere Messinstrumente für interessante Variablen im Rahmen möglicher explorativer Analysen.
...
* Erweitern Sie Ihre Präregistrierung mit Inhalten in den Feldern M12, M13, AP3, AP4
  * M12 und M13, siehe Folie 9 und Schritt 1.
  * Für AP3, siehe Folien 11-13 = Welche Vorverarbeitung ist nötig für die Messinstrumente, für die Sie sich in Schritt 1 entschieden haben? 
  * Für AP4 können Sie den Text aus der Präregistrierungs-Vorlage übernehmen (ggf. übersetzen, falls die restliche Präregistrierung deutsch ist).
...
* Nutzen Sie das formr-Template auf studynet für [eigene Themen](https://studynet.hs-fresenius.de/goto_STUDYNETHSF_file_33543_download.html) oder [das Interventionsthema](https://studynet.hs-fresenius.de/goto_STUDYNETHSF_file_42775_download.html).
...
* Sollten Sie ein experimentelles Design planen, schauen Sie sich den Run "reflection" in formr als Beispiel an: Hier wird wiederholt eine Randomisierung angewandt, um Versuchspersonen auf zufällig auf 1 von 3 Bedingungen zuzuteilen. Ähnlich (wenn auch weniger komplex) wird Ihr Run i.d.R. aussehen. **Wenn Sie dabei Hilfe brauchen, dann kommen Sie gerne auf mich zu, und ich erkläre es Ihnen genauer.** Gerne auch per Email.
...
* Aktuell sind im Template nur die "A"-Bedingungen drin. Wer gerne auch schon die Instruktionen für die anderen Bedingungen sehen möchte, wendet sich bitte per Email an mich.
...
**Folgende Gruppen mit Interventionsthema gehen nun in Raum P5 002 mit Nensy Le**
- The small five (Sara Diané, Katharina Effenberger, Anne Hoffmann, Katina Wahl, Fisnik Zenuni)
- Die Signifikanzjäger (Leonie Manz, Anna Vlaminck, Matthias Möhler, Marie Mayer-Martin, Blanca Sterr)

**Folgende Gruppen gehen nun in Raum P5 002 mit Claudia Dörrler**
- Attachment.pdf (Tamina Jung, Alexander Wimmer, Marcus Ifland, Isabella Bilan, Benita Mertzianis)
- OCEANs 5 (Alina Kindermann, Lisa Eisenknöppel, Antonia Baier, Carolin Voß, Marlene Hammer)

**Folgende Gruppen gehen nun in Raum P5 003 mit Caroline Zygar-Hoffmann**
- ? (Marie Harke, Julia Thies, Elmir Gorcevic, Tabea Schwarz, Lavinia Lux)
- Persönlichkeit und Bindungsstile (Aaron Bernatowicz, Carla Kaestle, Amelie Kunkel, Lisa Jaegers, Philine Hufnagel)
- Rosanen Five (Antonia Papius, Marie - Amelie Heinrich, Anna - Clara Siebert, Anna Emilia Planert, 
Jule Fellmann)
- Deadline Dodgers (Michael Rehm, Larissa Gohn, Ayse Mede, Emanuel Stoica, Niklas Wittenberger)
